      ...
      <el-form :model="addForm" :rules="addFormRules" ref="addFormRef" label-width="100px" label-position="top">
        <el-tabs v-model="activeIndex" tab-position="left" :before-leave="beforeTabLeave" @tab-click="tabClicked">
          ...
          <el-tab-pane label="商品图片" name="3">
            ...
            <el-upload :action="uploadURL" :on-preview="handlePreview" :on-remove="handleRemove" list-type="picture" :headers="headerObj" :on-success="handleImgSuccess">
  ...
  methods: {
    ...
    addGoods() {
      this.$refs.addFormRef.validate(async (valid) => {
        ...
        */
        //处理商品所属分类数据
        //this.addForm.goods_cat = this.addForm.goods_cat.join(',') //导致级联选择器关联的goods_cat发生异常
        //  const form = addForm //浅拷贝，不行
        //使用lodash工具
