      ...
      <el-table :data="goodsList" border stripe>
        ...
        <el-table-column label="操作" width="150px">
          <template slot-scope="scope">
            <el-button siza="mini" type="primary" icon="el-icon-edit" @click="goEditpage(scope.row.goods_id)"></el-button>
            <el-button siza="mini" type="danger" icon="el-icon-delete" @click="removeById(scope.row.goods_id)"></el-button>
          </template>
        </el-table-column>
      </el-table>
